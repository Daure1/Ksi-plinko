...
let slot_costs_list = [
    [10, 5, 2, 1, 0.5, 1, 2, 5, 10], // 8 lines slot costs
    [10, 10, 5, 2, 0.5, 0.5, 2, 5, 10, 10], // 9 lines slot costs
    [50, 10, 5, 2, 1, 0.5, 1, 2, 5, 10, 50], // 10 lines slot costs
    [50, 10, 5, 5, 1, 0.5, 0.5, 1, 5, 5, 10, 50], // 11 lines slot costs
    [100, 50, 10, 5, 2, 1, 0.5, 1, 2, 5, 10, 50, 100], // 12 lines slot costs
];
var pegs = []; //Store pegs objects
var openning; //Store the openning
var bet = 100; //Bet amount
var points = 1000 //Amount of points
let music;
var top_bounce = 0.5;
